...
upsample_filter_pool4_tensor_x2 = tf.Variable(upsample_filter_pool4_np_x2, name='vgg_16/fc8/pool4_conv_x2')

upsampled_logits = tf.nn.conv2d_transpose(logits, upsample_filter_pool4_tensor_x2,
...
upsample_filter_pool3_tensor_x2 = tf.Variable(upsample_filter_pool3_np_x2, name='vgg_16/fc8/pool3_conv_x2')

upsampled_logits = tf.nn.conv2d_transpose(upsampled_logits, upsample_filter_pool3_tensor_x2,
                                          output_shape=tf.shape(aux_logits_pool3),
                                          strides=[1, 2, 2, 1],
                                          padding='SAME')
...
# pay attention that we don't need softmax in this case because
